          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <Link to="/" className="flex-shrink-0 transition-transform hover:scale-105">
                <img className="h-14 w-auto" src={logo1} alt="GAT Assurances" />
              </Link>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              {/* Contact Information */}
              <div className="flex items-center">
                <a href="mailto:gat@gat.com.tn" className="text-gray-600 hover:text-red-600 transition-colors duration-200 flex items-center mr-6">
                  <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                  </svg>
                  <span>gat@gat.com.tn</span>
                </a>
                <a href="tel:+21631334333" className="text-gray-600 hover:text-red-600 transition-colors duration-200 flex items-center">
                  <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                  </svg>
                  <span>+216 31 334 333</span>
                </a>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-14">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <Link to="/gat-assurances" className="text-gray-500 hover:text-red-600 px-3 py-2 transition-colors duration-200">GAT ASSURANCES</Link>
          </div>
        </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link to="/gat-assurances" className="block px-3 py-2 text-gray-500 hover:text-red-600 hover:bg-gray-50 rounded-md">GAT ASSURANCES</Link>
            </div>
